...
- [x] **Step 1: Añadir el script del gate**
...
- [x] **Step 2: Escribir la comprobación estructural**
...
- [x] **Step 3: Ejecutar el gate automatizado**
...
- [x] **Step 4: Smoke test manual contra OpenRouter (puntos 17 y 18)**
...
- [x] **Step 5: Subir un PDF de verdad y verlo llegar a `ready`**
...
- [x] **Step 6: Verificar la dimensión y el modelo real (punto 18)**
...
- [x] **Step 7: Preguntar desde la demo (punto 17)**
...
- [x] **Step 8: Comprobar la degradación (punto 11)**
...
- [x] **Step 9: Dejar `.env` como estaba**
...
- [x] **Step 10: Escribir el registro del gate**
...
- [x] **Step 11: Cerrar la fase en el roadmap**
